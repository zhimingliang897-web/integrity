...
async def create_stealth_browser(playwright, headless: bool = False, proxy: str = None):
    """
    创建反检测浏览器实例（异步版本）
...
def inject_cookies(context, cookie_str: str, domain: str):
    """
    向浏览器上下文注入 Cookie
    ...
    Args:
        ...
        domain: Cookie 所属域名
    """
    if not cookie_str or not domain:
        return
