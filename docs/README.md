...
| 📝 台词学习 | 扇贝单词导出+影视台词关联学习 | ✅ |
| 🎬 视频生成 | AI 剧本→分镜插图→配音→视频 | ✅ |
| 📚 课程摘要 | 上传课件 PDF，AI 生成复习大纲 | ✅ |
| 🔌 EasyApply | 浏览器插件一键填写求职表单 | ✅ |
| 📁 文件助手 | 本地文件夹 AI 问答，代码分析 | ✅ |
| ✏️ 小红书文案 | AI 生成小红书风格英文教育笔记 | ✅ |
| 🖼️ 小红书图片 | 文章一键转换为小红书多图 | ✅ |
| 🎫 抢票助手 | 自动监控抢票流程（私有项目） | ✅ |
| 📡 AI 热点 | 全球 12+ 源自动抓取 AI 资讯 | ✅ |
