...
| Token 计算 API | ✅ 完成 | `/api/tokens/calc` 正常 |
| AI 对比 API | ✅ 完成 | `/api/compare` 正常 |
| AI 辩论 API | ✅ 完成 | `/api/debate/*` 正常 |
| PDF 工具 API | ✅ 完成 | `/api/pdf/*` 正常（部分功能暂未实现） |
| 台词学习 API | ✅ 完成 | `/api/lines/*` 正常 |
